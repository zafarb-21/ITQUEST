  ...
  return (
    <>
      <PageHero
        ...
        description="Whether you are planning infrastructure, strengthening security, improving support coverage, building a digital platform, or exploring smart systems, our team is ready to help."
