...
export const metadata: Metadata = buildMetadata(
  "Request a Quote",
  "Request a tailored quote from ITQUEST AFRICA for networking, digital systems, hardware sourcing, or smart IoT solutions in Zimbabwe.",
);
  ...
  return (
    <>
      <PageHero
        ...
        description="Use this form to outline your environment, priorities, and project timing. ITQUEST AFRICA will use that context to frame a more relevant response for infrastructure, digital systems, supply, or smart monitoring work."
      />
              ...
              <div className="section-panel p-8 md:p-10">
                ...
                <div className="mt-6 space-y-4">
                  {[
                    ...
                    "Whether you need networking, web systems, hardware, or smart monitoring",
